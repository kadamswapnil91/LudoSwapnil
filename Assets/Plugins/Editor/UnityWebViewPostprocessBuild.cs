...
internal class AndroidManifest : AndroidXmlDocument {
    ...
    internal bool SetUsesCleartextTraffic(bool enabled) {
        ...
        bool changed = false;
        if (ApplicationElement.GetAttribute("usesCleartextTraffic", AndroidXmlNamespace) != ((true) ? "true" : "false")) {
            ApplicationElement.SetAttribute("usesCleartextTraffic", AndroidXmlNamespace, (true) ? "true" : "false");
            changed = true;
        }
        return changed;
    }
    ...
    internal bool SetHardwareAccelerated(bool enabled) {
        ...
        if (activity.GetAttribute("hardwareAccelerated", AndroidXmlNamespace) != ((true) ? "true" : "false")) {
            activity.SetAttribute("hardwareAccelerated", AndroidXmlNamespace, (true) ? "true" : "false");
            changed = true;
        }
        return changed;
    }
